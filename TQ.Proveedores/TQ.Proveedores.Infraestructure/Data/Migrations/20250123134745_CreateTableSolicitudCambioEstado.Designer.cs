...
namespace TQ.Proveedores.Infraestructure.Data.Migrations
{
    ...
    [Migration("20250123134745_CreateTableSolicitudCambioEstado")]
    partial class CreateTableSolicitudCambioEstado
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TQ.Proveedores.Domain.Evaluaciones.SolicitudCambioEstado", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("EP_SolicitudCambioEstado", (string)null);
                });
            ...
            modelBuilder.Entity("TQ.Proveedores.Domain.Evaluaciones.SolicitudCambioEstado", b =>
                {
                    b.HasOne("TQ.Proveedores.Domain.Configuracion.Usuario", "Aprobador")
                        .WithMany()
