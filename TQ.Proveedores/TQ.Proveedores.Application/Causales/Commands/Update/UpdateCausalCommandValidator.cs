...
{
    public class UpdateCausalCommandValidator : AbstractValidator<UpdateCausalCommand>
    {
        public UpdateCausalCommandValidator()
        {
            RuleFor(p => p.Id)
                .NotEmpty().WithMessage("La causal que intenta actualizar está vacía.");
